...
let s:red        = { "gui": "#a91718", "cterm": "146" }
...
call s:h("Constant",      { "fg": s:purple3 })
...
call s:h("jsFutureKeys",        { "fg": s:red })
call s:h("jsBuiltins",          { "fg": s:red })
...
call s:h("jsStorageClass",      { "fg": s:red })
